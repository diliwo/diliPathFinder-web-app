...
export class ProfessionsService {
    ...
    getall(
        ...
        filter: string = '',
        orderBy: string = ""
    ): Observable<ProfessionMv.ProfessionList> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ProfessionMv.ProfessionList>><any>_observableThrow(e);
                }
            } else
                return <Observable<ProfessionMv.ProfessionList>><any>_observableThrow(response_);
        }));
    }

    protected processIsServiceUniqueAll(response: HttpResponseBase): Observable<ProfessionMv.ProfessionList> {
        ...
        if (status === 200) {
            return servicesLib.blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                ...
                result200 = ProfessionMv.ProfessionList.fromJS(resultData200);
        ...
        return _observableOf<ProfessionMv.ProfessionList>(<any>null);
    }
