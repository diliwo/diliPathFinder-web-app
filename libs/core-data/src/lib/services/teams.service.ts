      ...
      return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
          ...
          if (response_ instanceof HttpResponseBase) {
              try {
                  ...
                  return <Observable<Teams>><any>_observableThrow(e);
              }
          } else
              return <Observable<Teams>><any>_observableThrow(response_);
      }));
    }

    protected processIsServiceUniqueAll(response: HttpResponseBase): Observable<Teams> {
      ...
      if (status === 200) {
          ...
          result200 = Teams.fromJS(resultData200);
      ...
      return _observableOf<Teams>(<any>null);
    }
