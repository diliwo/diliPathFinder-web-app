...
@Component({
  selector: 'frontend-personal-situation-administrative-status-list',
  templateUrl: './personal-situation-administrative-status-list.component.html',
  styleUrls: ['./personal-situation-administrative-status-list.component.scss']
})
export class PersonalSituationAdministrativeStatusListComponent {
