...
@Component({
  selector: 'frontend-personal-situation-housing-list',
  templateUrl: './personal-situation-housing-list.component.html',
  styleUrls: ['./personal-situation-housing-list.component.scss']
})
export class PersonalSituationHousingListComponent {
