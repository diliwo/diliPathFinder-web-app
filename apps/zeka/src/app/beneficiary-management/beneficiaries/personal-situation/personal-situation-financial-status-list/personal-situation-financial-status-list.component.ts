...
@Component({
  selector: 'frontend-personal-situation-financial-status-list',
  templateUrl: './personal-situation-financial-status-list.component.html',
  styleUrls: ['./personal-situation-financial-status-list.component.scss']
})
export class PersonalSituationFinancialStatusListComponent {
