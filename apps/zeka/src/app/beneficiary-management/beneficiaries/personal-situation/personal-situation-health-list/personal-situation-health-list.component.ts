...
@Component({
  selector: 'frontend-personal-situation-health-list',
  templateUrl: './personal-situation-health-list.component.html',
  styleUrls: ['./personal-situation-health-list.component.scss']
})
export class PersonalSituationHealthListComponent {
